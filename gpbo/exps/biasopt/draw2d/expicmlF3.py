...
axisset={12:[1e2,1e4,1e-6,1e1],13:[2*1e2,2*1e4,1e-6,1e1]}
if mode=='run':
    if vers==2:
    ...
    gpbo.plotall(all2confs+all3confs,40,rpath,trueopt=truemin-1e-99,logx=True,labelfn=labelfn,axisset=axisset,needed=[13],legend=True)
else:
    pass
